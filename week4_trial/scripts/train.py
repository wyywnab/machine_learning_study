...
def get_data_loaders(batch_size, seed, num_workers):
    ...
    train_set = CIFAR10("..\..\cifar10_data", transform=train_set_transform, download=True, train=True)
    ...
    test_set = CIFAR10("..\..\cifar10_data", transform=test_set_transform, download=True, train=False)
